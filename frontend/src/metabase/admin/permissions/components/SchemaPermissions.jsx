...
export default class SchemaPermssions extends Component {
    ...
    onChangeAccessType(newAccessType) {
        const schemaPermissions = this.state.schemaPermissions || this.props.schemaPermissions || {};

        PermissionsAPI.updateSchemaPermissions({id: schemaPermissions.id, unrestricted_table_access: newAccessType === "unrestricted"}, (function (newSchemaPermissions) {
            this.setState({
    ...
    createTablePermissions(tablePermissions) {
        ...
        PermissionsAPI.createTablePermissions({table_id: tablePermissions.table_id, group_id: groupID}).then((function (newPermissions) {
    ...
    deleteTablePermissions(tablePermissions) {
        PermissionsAPI.deleteTablePermissions({id: tablePermissions.id}).then((function () {
    ...
    render() {
        ...
        console.log("schemaPermissions:", schemaPermissions); // NOCOMMIT
